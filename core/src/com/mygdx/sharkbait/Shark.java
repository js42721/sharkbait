...
public class Shark extends TileSprite implements Serializable {
     ...
     * 
     * @return the shark's movement delay
     */
     ...
     * 
     * @return the previous position of the shark
     */
     ...
     * 
     * The caller is responsible for ensuring that the new position is adjacent
     * to the last one.
     * 
     ...
     * 
     * The caller is responsible for ensuring that the position is attackable
     * (i.e. adjacent to the shark and equal to the player's position).
     * 
